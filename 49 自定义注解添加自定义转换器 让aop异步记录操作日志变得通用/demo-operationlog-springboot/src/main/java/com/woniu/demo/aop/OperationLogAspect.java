...
public class OperationLogAspect {
    ...
    private OperationLogVo recordLog(ProceedingJoinPoint joinPoint) throws InstantiationException, IllegalAccessException {
...
//            operationLogVo.setParams(JSON.toJSONString(joinPoint.getArgs()));
            ...
            Class<? extends Convert> convert = optLogger.convert();
            Convert newInstance = convert.newInstance();
            operationLogVo = newInstance.convert(args[0]);
        }
        // 操作类型
