package com.company.project.config.aspect;

import com.company.project.config.exception.CommonException;
...
public class CheckPermissionsAspect {
    ...
    @Pointcut("@annotation(com.company.project.config.aspect.CheckPermissions)")
